...
namespace HouseRent.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private bool MatchLogin(LoginModel user)
        {

           User findUser = db.User.FirstOrDefault(p=>p.LoginName==user.UserName&&p.Password==user.Password);
