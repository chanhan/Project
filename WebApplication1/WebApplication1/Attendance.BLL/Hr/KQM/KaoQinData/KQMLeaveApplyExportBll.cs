...
{
    public class KQMLeaveApplyExportBll : BLLBase<IKQMLeaveApplyExportDal>
    {
        /// <summary>
        /// 獲取請假信息用於導出Excel
        /// </summary>
        ...
        {
            return DAL.getApplyData(Privileged, SqlDep, depName, billNo, workNo, localName, LVTypeCode, status, testify, startDate, endDate, applyStartDate, applyEndDate, applyType, flag, IsLastYear);
        }
        /// <summary>
        /// 根據model獲取請假信息
        /// </summary>
        ...
        {
           return DAL.getLeaveApply( leaveApplyViewModel);
        }
        /// <summary>
        /// 獲取個人請假信息，用於導出Excel
        /// </summary>
        ...
        public List<LeaveApplyViewModel> getApplyList(string personCode, string billNo, string LVTypeCode, string status, string startDate, string endDate, string applyType)
        {
            return DAL. getApplyList( personCode,  billNo,  LVTypeCode,  status,  startDate,  endDate,  applyType);
        }
    }
}
