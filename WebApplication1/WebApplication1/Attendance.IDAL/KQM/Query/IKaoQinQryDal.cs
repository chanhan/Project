...
{
    [RefClass("KQM.Query.KaoQinQryDal")]
    public interface IKaoQinQryDal
    {
        /// <summary>
        /// 根據條件分頁查詢
        /// </summary>
        ...
        /// <param name="flagB"></param>
        /// <returns></returns>
        DataTable GetKaoQinDataForExport(string sql, string depname, string IsMakeup, string IsSupporter, string EmployeeNo, string BatchEmployeeNo, string LocalName, string fromDate, string toDate, string StatusName, string ExceptionType, string ShiftNo, string Status, bool flagA, bool flagB);
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        List<KaoQinDataQueryModel> GetList(DataTable dt);
