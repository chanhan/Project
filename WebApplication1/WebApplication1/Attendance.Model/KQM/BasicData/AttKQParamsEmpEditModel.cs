 ...
 * 
 * 檔案名： AttKQParamsEmpEditModel.cs
...
namespace GDSBG.MiABU.Attendance.Model.KQM.BasicData
{
    ...
    /// 考勤參數設定(人員)臨時表實體類
    /// </summary>
    [Serializable, TableName("GDS_ATT_KQPARAMSEMP", SelectTable = "GDS_ATT_KQPARAMSEMP_EDIT_V")]
    public class AttKQParamsEmpEditModel : ModelBase
    {
