<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaSelector.aspx.cs" Inherits="GDSBG.MiABU.Attendance.Web.HRM.AreaSelector" %>
                ...
                <igtbl:UltraWebGrid ID="UltraWebGridOtherData" runat="server" Width="100%" Height="100%">
                    ...
                    <Bands>
                        <igtbl:UltraGridBand BaseTableName="signledata" Key="signledata">
                            <Columns>
                                <igtbl:UltraGridColumn BaseColumnName="AreaCode" IsBound="false" Key="AreaCode" Width="50%">
                                    <Header Caption="<%$Resources:ControlText,gvAreaCode %>">
                                    </Header>
                                </igtbl:UltraGridColumn>
                                <igtbl:UltraGridColumn BaseColumnName="SINGLENAME" IsBound="false" Key="SINGLENAME" Width="50%">
