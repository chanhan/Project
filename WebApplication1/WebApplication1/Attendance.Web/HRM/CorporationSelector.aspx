<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorporationSelector.aspx.cs" Inherits="GDSBG.MiABU.Attendance.Web.HRM.CorporationSelector" %>
                ...
                <igtbl:UltraWebGrid ID="UltraWebGridOtherData" runat="server" Width="100%" Height="100%">
                    ...
                    <Bands>
                        <igtbl:UltraGridBand BaseTableName="signledata" Key="signledata">
                            <Columns>
                                <igtbl:UltraGridColumn BaseColumnName="CorporationId" IsBound="false" Key="CorporationId" Width="50%">
                                    <Header Caption="<%$Resources:ControlText,gvCorporationId %>">
                                    </Header>
                                </igtbl:UltraGridColumn>
                                <igtbl:UltraGridColumn BaseColumnName="simplename" IsBound="false" Key="simplename" Width="50%">
