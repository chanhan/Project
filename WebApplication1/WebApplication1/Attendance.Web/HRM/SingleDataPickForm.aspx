<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleDataPickForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.HRM.SingleDataPickForm" %>
                ...
                <igtbl:UltraWebGrid ID="UltraWebGridOtherData" runat="server" Width="100%" Height="100%">
                    ...
                    <Bands>
                        <igtbl:UltraGridBand BaseTableName="signledata" Key="signledata">
                            <Columns>
                                <igtbl:UltraGridColumn BaseColumnName="depcode" IsBound="false" Key="depcode" Width="50%">
                                    <Header Caption="<%$Resources:ControlText,gvHeaderDepCode %>">
                                    </Header>
                                </igtbl:UltraGridColumn>
                                <igtbl:UltraGridColumn BaseColumnName="depname" IsBound="false" Key="depname" Width="50%">
