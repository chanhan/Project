<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KQMLeaveApplyEditForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.Hr.KQM.KaoQinData.KQMLeaveApplyEditForm" %>
...
<head runat="server">
    ...
    <script>
        		function GetDeputy()
		{
            ...
            if(ProxyWorkNo.length==0&&(document.getElementById("ProcessFlag").value=="Add"||document.getElementById("ProcessFlag").value=="Modify"))
            {
                ...
                document.getElementById("hidProxyName").value="";
                document.getElementById("hidProxyNotes").value="";
            }
            if(ProxyWorkNo.length>0&&(document.getElementById("ProcessFlag").value=="Add"||document.getElementById("ProcessFlag").value=="Modify"))
            {
          $.ajax({
                                 type: "POST", url: "KQMLeaveApplyEditForm.aspx", data: {'workno': ProxyWorkNo,'flag': 'proxy'},dataType: "json",
              success: function(item) {
	                if(item.WorkNo==null)
              {
               document.getElementById("txtProxyNotes").readOnly=true;
                 document.getElementById("txtProxyWorkNo").value="";
                    document.getElementById("hidProxyName").value="";
                document.getElementById("hidProxyNotes").value="";
            ...
            else
            {
                   ...
                   document.getElementById("txtProxyName").value=item.LocalName==null?"":item.LocalName;
                   document.getElementById("txtProxyNotes").value=item.Notes==null?"":item.Notes;
                   document.getElementById("hidProxyName").value=  document.getElementById("txtProxyName").value;
                  document.getElementById("hidProxyNotes").value=  document.getElementById("txtProxyNotes").value;
    ...
    $(function(){
//           $("txtProxyName.ClientID").attr('readonly',true);
//           $("txtProxyNotes.ClientID").attr('readonly',true);
                   $("#img_edit").toggle(
                function(){
                    $("#tr_edit").hide();
           ...
           function ConsortIsMandatory(ConsortInFoxconn)
       {
    	    ...
    	    function onChangeLVTypeCode(strValue)
	    {
            ...
            var sWorkNo=document.getElementById("txtEmployeeNo").value; 
                         $.ajax({
                                 type: "post", url: "KQMLeaveApplyEditForm.aspx", dataType: "text", data: {workno: sWorkNo,typecode:strValue,flag: 'LVTypeCode'},
       ...
       //是否顯示配偶資料             
        ...
        function Return()
        {
           ...
           // window.parent.document.all.tr_show_1.style.display="";       
        ...
        var Savestatus=document.getElementById("btnSave").disabled;
            ...
            if(sWorkNo!=""&&sStartDate!=""&&sEndDate!=""&&sStartTime!=""&&sEndTime!=""&&sLVTypeCode!="")
            {
                if(!validateCNDate(sStartDate)||!validateCNDate(sEndDate))
		        {
		           return ;
		             ...
		             $.ajax({
                                 type: "post", url: "KQMLeaveApplyEditForm.aspx", dataType: "text", data: {workno: sWorkNo,startDate:sStartDate+" "+sStartTime,endDate:sEndDate+" "+sEndTime,typecode:sLVTypeCode,flag: 'LVTotal'},
                                 success: function(msg) {
                                                                                        if(msg !="")
                                                                                   {
        ...
        {
       		             $.ajax({
                                 type: "post", url: "KQMLeaveApplyEditForm.aspx", dataType: "text", data: {workno: sWorkNo,startDate:sStartDate,flag: 'ShiftDeac'},
                                 success: function(msg) {
                                                                                  if(msg!=null)
                                                          {
                                                              if(msg!="")
...
<body>
    ...
    <input id="hidProxyName" type="hidden" name="hidProxyName" runat="server" />
    <input id="hidProxyNotes" type="hidden" name="hidProxyNotes" runat="server" />
                                        ...
                                        <asp:Panel ID="inputPanel" runat="server">
                                            <tr>
                                                ...
                                                <td class="td_input" style="width: 20%">
                                                    <asp:TextBox ID="txtEmployeeNo" runat="server" Width="100%" CssClass="input_textBox"
                                                        OnTextChanged="txtEmployeeNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </td>
                                                <td class="td_label_view" style="width: 13%">
                                                    &nbsp;
                                            ...
                                            <tr>
                                                <td class="td_label">
                                                    &nbsp;
                                                    <asp:Label ID="gvProxyWorkNo" runat="server">Proxy:</asp:Label>
                                                </td>
                                                <td class="td_input">
                                                ...
                                                <td class="td_input">
                                                    <asp:TextBox ID="txtProxyName" runat="server" Width="100%" CssClass="input_textBox" ReadOnly="true" BorderStyle="None"></asp:TextBox>
                                                </td>
                                                <td class="td_label">
                                                    &nbsp;
                                               ...
                                               <tr>
                                                ...
                                                <td class="td_input" colspan="3">
                                                    <asp:TextBox ID="txtProxyNotes" runat="server" Width="100%" CssClass="input_textBox" ReadOnly="true" BorderStyle="None"  ></asp:TextBox>
                                                </td>
                                                <td class="td_label">
                                                    &nbsp;
    ...
    <script type="text/javascript"><!--  
		...
		{  
            ...
            document.getElementById("divConsort").style.display="none"; 
            if(document.getElementById("ddlLVTypeCode").value=="J") //婚假
            {
                document.getElementById("divConsort").style.display="";
            ...
            { 
                var sWorkNo=document.getElementById("txtEmployeeNo").value;         
                             $.ajax({
                                 type: "post", url: "KQMLeaveApplyEditForm.aspx", dataType: "text", data: {workno: sWorkNo,typecode:document.getElementById("ddlLVTypeCode").value,flag: 'LVTypeCode'},
                                 success: function(msg) {
                                   if(msg=="Y")
                                              { 
                                                      alert(Message.BillRefuseAudit);           
