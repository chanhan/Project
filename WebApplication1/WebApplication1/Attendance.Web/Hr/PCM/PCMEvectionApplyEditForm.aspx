<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCMEvectionApplyEditForm.aspx.cs" Inherits="GDSBG.MiABU.Attendance.Web.Hr.PCM.PCMEvectionApplyEditForm" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript"><!--
       ...
       {
           $("#<%=txtRemarkCar.ClientID %>").css("display", "none");
           $("#<%=txtRemOther.ClientID %>").css("display", "none"); 
           $("#<%=lblOthers_.ClientID %>").css("display", "none");
          for (var i=0;i<5;i++)
          {
            if(i==0||i==4)
            {
                ...
                if(i==0) {
                    ...
                    if (item.checked) {$("#<%=lblOthers_.ClientID %>").css("display", "");$("#<%=lblOthers_.ClientID %>").text("司機"); $("#<%=txtRemarkCar.ClientID %>").css("display", "");   }
                }
                if(i==4) {

                    var item=document.getElementById(list.id+'_'+i);
                    if (item.checked) { $("#<%=lblOthers_.ClientID %>").css("display", ""); $("#<%=lblOthers_.ClientID %>").text("其他"); $("#<%=txtRemOther.ClientID %>").css("display", ""); }
                }
            }
            else {
       ...
       function Return() {
        ...
        $(function() {
        changeChoose(document.getElementById("rdoEvectionBy"));
            $("#tr_edit").toggle(
...
<body class="color_body">
                        ...
                        <table class="table_data_area">
                            ...
                            <tr class="tr_data_2">
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtRemOther" runat="server" Style="display: none"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="tr_data_1">
                                <td>
    ...
    <script type="text/javascript"><!-- 
		...
		{
		    document.getElementById("txtEmployeeNo").readOnly = true;
		    document.getElementById("ddlEvectionType").focus();
//		    document.getElementById("ddlEvectionType").select();
    	}
    	else {
