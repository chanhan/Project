...
{
    public partial class PCMLeaveApplyApproveForm : BasePage
    {
        ...
        private void Query(bool WindowOpen, string forwarderType)
        {
            ...
            {
                condition.Append(" AND a.ProxyWorkNo = '" + CurrentUserInfo.Personcode + "' and a.ProxyStatus='1' and a.Status='0' ");
