<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCMLeaveApplyApprovedForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.Hr.PCM.PCMLeaveApplyApprovedForm" %>

<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics2.WebUI.UltraWebGrid.v7.1, Version=7.1.20071.40, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PCMLeaveApplyApprovedForm</title>
    ...
    <script type="text/javascript"><!--
        function ShowBillDetail(BillNo) {
            ...
            openEditWin("PCMLeaveApproveCenterForm.aspx?BillNo=" + BillNo + "&ModuleCode=" + ModuleCode + "&OPENTYPE=PCMLeaveApprovedCenter", "PCMLeaveApprovedCenter", width, height);
        }
                            ...
                            <table class="inner_table" cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr style="width: 100%;" id="tr2">
                                                <td style="width: 100%;" class="tr_title_center">
                                                    <table cellspacing="0" cellpadding="0" border="0" style="height: 25px; background-image: url('../../CSS/Images_new/org_main_02.gif');
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="labapproved" runat="server" Text="labapproved"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <script language="javascript">                                            document.write("<DIV id='div_2' style='height:" + document.body.clientHeight * 94 / 100 + "'>");</script>
