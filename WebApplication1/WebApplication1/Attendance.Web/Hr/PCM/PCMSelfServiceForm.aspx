<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCMSelfServiceForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.Hr.PCM.PCMSelfServiceForm" %>
    ...
    <div>
        ...
        <div style="width: 100%">
            ...
            <div style="width: 100%" >
                <table cellspacing="0" cellpadding="0" class="table_title_area">
                    <tr style="width: 100%;">
                        <td style="width: 17px;" id="img_grid_4_1">
                    ...
                    <table style="width: 100%" cellspacing="0" cellpadding="0" align="center" border="0">
                        ...
                        <tr style="width: 100%">
                            ...
                            <td>
                                ...
                                <igtbl:UltraWebGrid ID="UltraWebGridOTMonthDetail" runat="server" Width="100%" Height="100%" OnDataBound="UltraWebGridOTMonthDetail_DataBound">
                                    <DisplayLayout UseFixedHeaders="true" CompactRendering="False" StationaryMargins="Header"
                                        AllowSortingDefault="Yes" RowHeightDefault="20px" Version="4.00" SelectTypeRowDefault="Single"
                                        HeaderClickActionDefault="SortSingle" BorderCollapseDefault="Separate" AllowColSizingDefault="Free"
                                            ...
                                            <Bands>
                                                    <igtbl:UltraGridBand AllowRowNumbering="NotSet" AddButtonCaption="" AddButtonToolTipText=""
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <igtbl:UltraGridColumn BaseColumnName="Status" Key="Status" IsBound="false"
                                                                Width="0" Hidden="true">
                                                                <Header Caption="Status">
                                                                </Header>
                                                            </igtbl:UltraGridColumn>
