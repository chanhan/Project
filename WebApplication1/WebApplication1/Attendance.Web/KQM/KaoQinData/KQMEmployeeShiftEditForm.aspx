<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KQMEmployeeShiftEditForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.KQM.KaoQinData.KQMEmployeeShiftEditForm" %>
...
<script language="javascript" type="text/javascript">
	...
	function DisplayRowData(row)
	{
		if(igtbl_getElementById("ProcessFlag").value.length==0 && row != null)
		{
			...
			document.all("HiddenEmployeeNo").value=igtbl_getElementById("txtEmployeeNo").value;
    ...
    if ($("#HiddenEmployeeNo").val()!="")
    {
         ...
         $("#<%=txtEmployeeNo.ClientID %>").addClass("input_textBox");
     ...
     {
         $("#<%=hidOperate.ClientID %>").attr("value","add"); 
         $("#<%=txtEmployeeNo.ClientID %>").removeAttr("disabled");
         $("#<%=ddlShiftNo.ClientID %>").removeAttr("disabled");
         $("#<%=txtStartDate.ClientID %>").removeAttr("readonly");
         $("#<%=txtEndDate.ClientID %>").removeAttr("readonly");
         $("#<%=txtStartDate.ClientID %>").addClass("input_textBox_haveborder");
         $("#<%=txtEndDate.ClientID %>").addClass("input_textBox_haveborder");
         $("#<%=btnQuery.ClientID %>").attr("disabled","true");
         $("#<%=btnAdd.ClientID %>").attr("disabled","true");
         $("#<%=btnDelete.ClientID %>").attr("disabled","true");
         $("#<%=btnModify.ClientID %>").attr("disabled","true");
      ...
      if($("#<%=ddlShiftNo.ClientID %>").val()!=null && $("#<%=ddlShiftNo.ClientID %>").val()!="")
    {
     ...
     else
     {
      ...
      return false;
        ...
        function sava_click()
    {
    $("#HiddenChineseName").val($("#<%=txtChineseName.ClientID %>").val());
    $("#HiddenSYC").val($("#<%=txtSYC.ClientID %>").val());
    $("#HiddenSYB").val($("#<%=txtSYB.ClientID %>").val());
        if ( $("#<%=ddlShiftNo.ClientID %>").val()=="")
        {
...
//                {
//                var empno;
//                empno=$.trim($("#<%=txtEmployeeNo.ClientID %>").val());
//                var flag=$("#<%=hidOperate.ClientID %>").val();
//                    if (empno!="")
//                        {
//                            $.ajax(
//                                   {
//                                     type:"post",url:"KQMEmployeeShiftEditForm.aspx",dataType:"json",data:{Empno:empno,Flag:flag},  
//                                     success:function(msg) 
//                                        {
//                                        if (msg.LocalName!=null)
//                                        {
//                                            $("#<%=txtChineseName.ClientID %>").val(msg.LocalName);
//                                            $("#<%=txtSYC.ClientID %>").val(msg.Syc);
//                                             $("#<%=txtSYB.ClientID %>").val(msg.DepName);
//                                        }
//                                        else
//                                        {
//                                        $("#<%=txtEmployeeNo.ClientID %>").val("");
    ...
    <table class="inner_table" cellspacing="0" cellpadding="0" width="100%">
        <tr valign="top">
            <td width="100%">
                ...
                <asp:HiddenField ID="HiddenChineseName" runat="server" />
                <asp:HiddenField ID="HiddenSYC" runat="server" />
                <asp:HiddenField ID="HiddenSYB" runat="server" />
                <table class="inner_table" cellspacing="0" cellpadding="0" width="100%">
             
                            <tr>
                                <td class="td_label" width="25%">
                                    &nbsp;
                                    <asp:Label ID="lblEmployeeNo" runat="server" ForeColor="Blue">EmployeeNo:</asp:Label>
                                </td>
                                <td class="td_input" width="30%">
                                    <asp:TextBox ID="txtEmployeeNo" runat="server" Width="100%" OnTextChanged="txtEmployeeNo_TextChanged"
                                        AutoPostBack="true"></asp:TextBox>
                                </td>
                                <td class="td_label" width="15%">
                                    &nbsp;
                                    <asp:Label ID="lblLocalName" runat="server">ChineseName:</asp:Label>
                                </td>
                                <td class="td_input" width="30%">
                                    <asp:TextBox ID="txtChineseName" runat="server" Width="100%" CssClass="input_textBox_no"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td_label">
                                    &nbsp;
                                    <asp:Label ID="lblSYC" runat="server">SYC:</asp:Label>
                                </td>
                                <td class="td_input">
                                    <asp:TextBox ID="txtSYC" runat="server" Width="100%" CssClass="input_textBox_no"></asp:TextBox>
                                </td>
                                <td class="td_label">
                                    &nbsp;
                                    <asp:Label ID="lblSYB" runat="server">SYB:</asp:Label>
                                </td>
                                <td class="td_input">
                                    <asp:TextBox ID="txtSYB" runat="server" Width="100%" CssClass="input_textBox_no"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td class="td_label">
                                    &nbsp;
                                    <asp:Label ID="lblShiftN" runat="server" ForeColor="Blue">ShiftNo:</asp:Label>
                                </td>
                                <td class="td_input" colspan="3">
                                    <asp:DropDownList ID="ddlShiftNo" runat="server" Width="95%">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="td_label">
                                    &nbsp;
                                    <asp:Label ID="lblNetSignDate" runat="server" ForeColor="Blue">ShiftDate:</asp:Label>
                                </td>
                                <td class="td_input" colspan="3">
                                    ...
                                    <tr style="width: 100%">
                                        ...
                                        <td>
                                            ...
                                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Width="100%" Height="100%">
                                                ...
                                                <Bands>
                                                    <igtbl:UltraGridBand BaseTableName="KQM_EmployeeShift" Key="KQM_EmployeeShift">
                                                        <Columns>
                                                            ...
                                                            <igtbl:UltraGridColumn BaseColumnName="EndDate" Key="EndDate" IsBound="false" Hidden="true">
