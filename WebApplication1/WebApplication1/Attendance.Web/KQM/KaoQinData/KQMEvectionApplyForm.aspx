<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KQMEvectionApplyForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.Hr.KQM.KaoQinData.KQMEvectionApplyForm" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript"><!--
         function UpProgress()
		{
			...
			document.getElementById("lblupload").innerText =Message.uploading;			
		}
        function CheckAll()
		{
			var sValue=false;
		...
		function OpenEdit(ProcessFlag)//彈出新增或修改頁面
		{
		    ...
		    if(ProcessFlag=="Modify")
		    {
			    ...
			    for(i=0;i<gRows.length;i++)
			    {
				    ...
				    {
				        Count+=1;	
				        Status=gRows.getRow(i).getCell(21).getValue();
			            switch (Status)
            ...
            document.getElementById("iframeEdit").src="KQMEvectionApplyEditForm.aspx?BillNo="+BillNo+"&ProcessFlag="+ProcessFlag+"&ModuleCode="+ModuleCode;
...
//		    for(i=0;i<gRows.length;i++)
//		    {
//			    if(document.getElementById("UltraWebGridLeaveApply_ci_0_0_"+i+"_CheckBoxCell").checked)
//			    {
//			        Count+=1;			        		
//			    }
//		    }			
...
//		    var rValue=window.showModalDialog("<%=sAppPath%>/Sys/TreeDataPickForm.aspx?DataType=Department&condition=&modulecode="
//		        +document.getElementById("HiddenModuleCode").value,window,"dialogWidth="+windowWidth+"px;dialogHeight="+windowHeight+"px;dialogLeft="+X+"px;dialogTop="+Y+"px;help=no;status=no;scrollbars=no");
//		    if(rValue.length>0)
//		    {
//		        document.getElementById("HiddenOrgCode").value=rValue.split(';')[0];
//		    }
//		    //document.getElementById("ButtonSendAudit").click();
//		    setTimeout('__doPostBack(\'btnSendAudit\',\'\')', 0);
//		    return true;
//		}
$(function(){
        $("#tr_edit").toggle(
    ...
    $(function(){
       $("#tr_showid").toggle(
            function(){$("#div_import").hide(); $(".img3").attr("src","../../CSS/Images_new/left_back_03.gif");},
            function(){$("#div_import").show(); $(".img3").attr("src","../../CSS/Images_new/left_back_03_a.gif");} ) 
   });   
...
<body class="color_body">
                                            ...
                                            <asp:Panel ID="pnlContent" runat="server">
                                                <table class="table_data_area">
                                                    <tr class="tr_data_1">
                                                        ...
                                                        <td width="15%">
                                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtDCode" runat="server" class="input_textBox_1" Width="100%"
                                                                    ...
                                                                    <td style="cursor: hand">
                                                                        <asp:Image ID="imgDepCode" runat="server" class="input_textBox_1" ImageUrl="../../CSS/Images_new/search_new.gif">
                                                                        </asp:Image>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr class="tr_data_2">
                                                        <td width="10%">
                                                            &nbsp;
                                                            <asp:Label ID="WorkNo" runat="server">WorkNo:</asp:Label>
                                                        </td>
                                                        <td width="15%">
                                                            <asp:TextBox ID="txtWorkNo" runat="server" class="input_textBox_2" Width="100%"></asp:TextBox>
                                                        </td>
                                                        <td width="10%">
                                                            &nbsp;
                                                        ...
                                                        <td width="25%">
                                                            <asp:TextBox ID="txtLocalName" runat="server" class="input_textBox_2" Width="100%"></asp:TextBox>
                                                        </td>
                                                        <td width="15%">
                                                            &nbsp;
                                                    ...
                                                    <tr class="tr_data_1">
                                                        ...
                                                        <%--                      <td>
                                                            <igtxt:WebDateTimeEdit ID="txtEvectionTime" class="input_textBox_1" runat="server"
                                                                EditModeFormat="yyyy/MM/dd HH:mm">
                                                                <ClientSideEvents ValueChange="CheckDate" />
                                ...
                                <table>
                                    <tr>
                                        <asp:Panel ID="pnlShowPanel" runat="server">
                                            ...
                                            <td>
                                                <asp:Button ID="btnAdd" runat="server" class="button_2" OnClientClick="return OpenEdit('Add')">
                                                </asp:Button>
                                                <asp:Button ID="btnModify" runat="server" class="button_2" OnClientClick="return OpenEdit('Modify')">
                                                </asp:Button>
                                            ...
                                            <td>
                                                <asp:Button ID="btnAudit" runat="server" class="button_2" OnClientClick="return ShowAudit()">
                                                </asp:Button>
                                                <asp:Button ID="btnCancelAudit" runat="server" class="button_morelarge" OnClick="btnCancelAudit_Click"
                                                    OnClientClick="return CheckCancelAudit()" />
                                                <asp:Button ID="btnSendAudit" runat="server" class="button_2" OnClick="btnSendAudit_Click"
                                                    OnClientClick="return CheckSendAudit()" />
                                            ...
                                            <Bands>
                                                <igtbl:UltraGridBand BaseTableName="gds_att_applyout" Key="gds_att_applyout">
                                                    <Columns>
                                                        ...
                                                        <igtbl:UltraGridColumn BaseColumnName="ApRemark" Key="ApRemark" IsBound="false" Width="100px"
                                                            HeaderText="ApRemark">
                                                            <Header Caption="<%$Resources:ControlText,gvApRemark %>">
                    ...
                    <asp:Panel ID="PanelImport" runat="server" Width="100%" Visible="false">
                        <table cellspacing="0" cellpadding="0" width="100%">
                            <tr style="cursor: hand">
                                <td>
                                    <table cellspacing="0" cellpadding="0" class="table_title_area">
                                        <tr style="width: 100%;" id="tr_showid">
                                            <td style="width: 100%;" class="tr_title_center">
                                                <table cellspacing="0" cellpadding="0" border="0" style="height: 25px; background-image: url('../../CSS/Images_new/org_main_02.gif');
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td width="100%" align="left" colspan="2">
                                        <a href="/ExcelModel/EvectionApplySample.xls">
                                            <asp:Label ID="lblUploadText" runat="server" Font-Bold="true"></asp:Label>
                                        </a>
                                        <asp:FileUpload ID="FileUpload" runat="server" />
                                        <asp:Button ID="btnImportSave" runat="server" class="button_2" Text="ImportSave"
                                                                ...
                                                                <igtbl:UltraGridBand BaseTableName="KQM_Import" Key="KQM_Import">
                                                                    <Columns>
                                                                        ...
                                                                        <igtbl:UltraGridColumn BaseColumnName="EvectionType" Key="EvectionType" IsBound="false"
                                                                            Hidden="True" HeaderText="EvectionType">
                                                                            <Header Caption="<%$Resources:ControlText,gvEvectionTypeName%>">
                                                                                <RowLayoutColumnInfo OriginX="17" />
                                                                            </Header>
                                                                            <Footer>
                                                                        ...
                                                                        <igtbl:UltraGridColumn BaseColumnName="EvectionTime" Key="EvectionTime" IsBound="false"
                                                                            Width="130px" HeaderText="EvectionTime">
                                                                            <Header Caption="<%$Resources:ControlText,gvEvectionTime %>">
                                                                                <RowLayoutColumnInfo OriginX="7" />
                                                                            </Header>
                                                                            <Footer>
                                                                        ...
                                                                        <igtbl:UltraGridColumn BaseColumnName="EvectionRoad" Key="EvectionRoad" IsBound="false"
                                                                            Width="80px" HeaderText="EvectionRoad">
                                                                            <Header Caption="<%$Resources:ControlText,gvEvectionRoad%>">
                                                                                <RowLayoutColumnInfo OriginX="12" />
                                                                            </Header>
                                                                            <Footer>
                                                                        ...
                                                                        <igtbl:UltraGridColumn BaseColumnName="ReturnTime" Key="ReturnTime" IsBound="false"
                                                                            Width="120px" HeaderText="ReturnTime">
                                                                            <Header Caption="<%$Resources:ControlText,gvReturnTime%>">
                                                                                <RowLayoutColumnInfo OriginX="12" />
                                                                            </Header>
                                                                            <Footer>
                                                                        ...
                                                                        <igtbl:UltraGridColumn BaseColumnName="EvectionBy" Key="EvectionBy" IsBound="false"
                                                                            Width="60px" HeaderText="EvectionBy">
                                                                            <Header Caption="<%$Resources:ControlText,gvEvectionBy%>">
                                                                                <RowLayoutColumnInfo OriginX="12" />
                                                                            </Header>
                                                                            <Footer>
    ...
    {        
        ...
        document.getElementById("PanelAudit").style.top=igtbl_getElementById("btnAudit").style.top;
