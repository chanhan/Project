<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanySelector.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.SystemManage.SystemSafety.CompanySelector" %>
...
<body>
    ...
    <div id="div_select">
        <igtbl:UltraWebGrid ID="UltraWebGridCompany" runat="server" Width="100%" Height="100%">
                ...
                <igtbl:UltraGridBand>
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="COMPANYID" IsBound="false" Key="COMPANYID"
                            Width="40%">
                            <Header Caption="<%$Resources:ControlText,gvHeadCompanyID %>" Fixed="true">
                            </Header>
                    ...
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="COMPANYNAME" IsBound="false" Key="COMPANYNAME"
                            Width="50%">
                            <Header Caption="<%$Resources:ControlText,gvHeadCompanyName%>" Fixed="true">
                            </Header>
                        </igtbl:UltraGridColumn>
                    </Columns>
                </igtbl:UltraGridBand>
