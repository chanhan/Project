<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanguageSelector.aspx.cs" Inherits="GDSBG.MiABU.Attendance.Web.SystemManage.SystemSafety.LanguageSelector" %>
...
<body>
 <form id="form1" runat="server">
    ...
    <div id="div_select" >
        <igtbl:UltraWebGrid ID="UltraWebGridLanguage" runat="server" Width="100%" Height="100%">
            ...
            <Bands>
                <igtbl:UltraGridBand>
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="LANGUAGE" IsBound="false" Key="DATACODE"
                            Width="40%">
                            <Header Caption="<%$Resources:ControlText,gvHeadLanguage %>" Fixed="true">
                            </Header>
                        </igtbl:UltraGridColumn>
                    </Columns>
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="DESCRIPTION" IsBound="false" Key="DATAVALUE"
                            Width="50%">
                            <Header Caption="<%$Resources:ControlText,gvHeadLanguageName %>" Fixed="true">
                            </Header>
                        </igtbl:UltraGridColumn>
                    </Columns>
                </igtbl:UltraGridBand>
