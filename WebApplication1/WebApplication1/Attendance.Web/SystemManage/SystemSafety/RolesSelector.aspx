<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RolesSelector.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.SystemManage.SystemSafety.RolesSelector" %>
    ...
    <div id="div_select">
        <igtbl:UltraWebGrid ID="UltraWebGridRoles" runat="server" Width="100%" Height="100%">
            ...
            <Bands>
                <igtbl:UltraGridBand>
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="ROLESCODE" IsBound="false" Key="ROLESCODE"
                            Width="40%">
                            <Header Caption="<%$Resources:ControlText,gvHeadRolecode %>" Fixed="true">
                            </Header>
                    ...
                    <Columns>
                        <igtbl:UltraGridColumn BaseColumnName="ROLESNAME" IsBound="false" Key="ROLESNAME"
                            Width="50%">
                            <Header Caption="<%$Resources:ControlText,gvHeadRolesName %>" Fixed="true">
                            </Header>
                        </igtbl:UltraGridColumn>
                    </Columns>
                </igtbl:UltraGridBand>
