<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherAllowanceForm.aspx.cs"
    Inherits="GDSBG.MiABU.Attendance.Web.WFReporter.OtherAllowanceForm" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" width="100%" class="table_data_area">
                                        <asp:Panel ID="inputPanel" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtYearMonth" runat="server" Width="100%" CssClass="input_textBox"></asp:TextBox>
